...
public class CommandRequestInteractors extends SimpleInteractors<XMMCXiaoMingPlugin> {
//    @Override
...
////        Preconditions.state(commandRequest.isEnabled(), "command request hadn't enabled");
////
